...
프로젝트 실행 전 아래와 같이 .env 파일을 수정해주세요.
...
과제 1에서 정의한 페르소나(45세 팀장급/C레벨 여성)의 핵심 페인포인트는  
...
본 과제는 2일이라는 제한된 시간 내에 기획부터 구현까지 완료해야 했기 때문에,  
초기부터 "완성도 높은 일부 기능에 집중하는 것"을 목표로 설정했습니다.
